...
- Project context belongs in the standalone copied extension: load actual project files, bound injected text, report board drift as an advisory, and restack speech registers before every LLM call
