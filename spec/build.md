...
- Coordinator status is static. Dirty-file count dropped `327fc2e`. Sequential after that: unused wake sweep export, tests stop owning prompt prose, one home for handoff policy, stale board/vision prose.
