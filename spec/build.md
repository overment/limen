...
- Intent prose matches landed reality. Tests no longer inventory prompt prose `e030714`. Handoff policy already has one home in the shop manual (no second register rule). Sequential after that: wake/Herdr size only if the budget is still tight.
