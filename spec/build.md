...
- Optional `limen land` merges a ready job onto a named target with owner confirm (`F717-land-merges-a-ready-job`, 🟠 ACTIVE). Slices 1–5 are healthy enough to try; stub and stop if it becomes a second merge control plane.
