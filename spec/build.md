...
- Tests stop owning prompt prose. Sweep collector is private `482715d`; coordinator footer is static `ab70649`; dirty-file count dropped `327fc2e`. Sequential after that: one home for handoff policy, stale board/vision prose.
