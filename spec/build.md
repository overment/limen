...
- Unused wake sweep export. Coordinator status is static `ab70649`; dirty-file count dropped `327fc2e`. Sequential after that: tests stop owning prompt prose, one home for handoff policy, stale board/vision prose.
