...
- [ ] F091: implement the authorized receiver-owned export contract and CLI reader; correlated Alice Mac proof remains missing, Johnny actively shepherds it without relying on finish webhooks
