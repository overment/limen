...
| 3 | **F081** spawn refuses an unusable route | ACTIVE | Spawn preflight rejects bad route before planting; no retries / model selection in scope | `[~]` implementation starts after transport landing; authentication-only proof remains insufficient |
