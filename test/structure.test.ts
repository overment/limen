...
test("strict TypeScript and templates preserve the capability-judgment line", async () => {
	...
	assert.deepEqual((await readdir(join(ROOT, "templates/.history"))).sort(), ["agents.md", "communication.md", "picture.md", "reviewer.md", "worker.md"]);
	for (const name of ["agents.md", "communication.md", "picture.md", "reviewer.md", "worker.md"]) {
